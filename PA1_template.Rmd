...
The impact caused by imputing missing data is a difference of **`r round(mean.steps.per.day - new.mean.steps.per.day,1)`** in the mean of steps per day and **`r median.steps.per.day - new.median.steps.per.day`** in the median of steps per day. The impact is smallerin median value because we have replaced the NANs with interval median values.
